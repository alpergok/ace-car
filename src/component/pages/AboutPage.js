          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
            <div className="our-team">
              ...
              <ul className="social">
                ...
                <li><a href="https://instagram.com/cemozgur" className="fa fa-instagram" aria-hidden="true"></a></li>
                <li><a href="https://www.linkedin.com/in/cem-%C3%B6zg%C3%BCr-56a8971b4/" className="fa fa-linkedin" aria-hidden="true"></a></li>
                <li><a href="https://codepen.io/collection/XdWJOQ/" className="fa fa-facebook" aria-hidden="true"></a></li>
              </ul>
            </div>
          </div>
          <div className="col-12 col-sm-6 col-md-4 col-lg-3">
            <div className="our-team">
              ...
              <ul className="social">
                ...
                <li><a href="https://www.instagram.com/anvarpashanabiyev" className="fa fa-instagram" aria-hidden="true"></a></li>
                <li><a href="https://www.linkedin.com/in/anvarpasha-nabiyev-651b32164/" className="fa fa-linkedin" aria-hidden="true"></a></li>
                <li><a href="https://codepen.io/collection/XdWJOQ/" className="fa fa-facebook" aria-hidden="true"></a></li>
              </ul>
            </div>
          </div>
